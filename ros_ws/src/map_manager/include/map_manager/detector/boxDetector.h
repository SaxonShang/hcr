#ifndef MAP_MANAGER_BOX_DETECTOR_H
#define MAP_MANAGER_BOX_DETECTOR_H

// NOTE:
// This file is intentionally header-only to avoid double-definition issues.
// It was previously stored as a .cpp and both included and compiled.
// Keep it header-only and do not add it as a CMake source file.
...
#endif  // MAP_MANAGER_BOX_DETECTOR_H
